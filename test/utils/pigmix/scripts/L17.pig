...
A = load '/pigmix/widegroupbydata' using org.apache.pig.test.udf.storefunc.PigPerformanceLoader()
...
B = group A by (user, action, timespent, query_term, ip_addr, timestamp,
        ...
        estimated_revenue_2) parallel $reducers;
...
store C into '/pigmixresults/L17out';
